...
const SlackClone = () => {
  ...
  const { 
    ...
    loadMessagesFromBackend // NEW: Get the backend loading function
  ...
  // NEW: Load messages when channel changes
  const handleChannelClick = async (channel) => {
    setCurrentChannel(channel);
    setCurrentDM(null);
    
    // Load messages from backend for this channel
    await loadMessagesFromBackend(currentWorkspace.id, channel);
  };
